...
public class DefineSimpleUrlAuthenticationFailureHandler implements AuthenticationFailureHandler{  
    ...
    public DefineSimpleUrlAuthenticationFailureHandler() {  
    }  
  
    public DefineSimpleUrlAuthenticationFailureHandler(String defaultFailureUrl) {  
